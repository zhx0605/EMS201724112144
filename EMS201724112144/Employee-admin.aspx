<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee-admin.aspx.cs" Inherits="EMS201724112144.Employee_admin" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">查询条件：<div class="auto-style2">
                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged" Width="885px">
